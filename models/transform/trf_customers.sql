...
final as (
    select {{ dbt_utils.generate_surrogate_key(['customer_id']) }} as pk_customers, 
    {{ dbt_utils.generate_surrogate_key(['customer_id']) }} as hk_customers, *, current_timestamp() as last_updated,
